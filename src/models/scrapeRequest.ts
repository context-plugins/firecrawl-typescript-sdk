...
import {
  ...
  scrapeRequestActionsSchema,
} from './containers/scrapeRequestActions.js';
...
export const scrapeRequestSchema: Schema<ScrapeRequest> = lazy(() =>
  typedExpandoObject(
    {
      url: ['url', string()],
      ...
      actions: ['actions', optional(array(scrapeRequestActionsSchema))],
