...
import {
  ...
  batchScrapeRequestActionsSchema,
} from './containers/batchScrapeRequestActions.js';
...
export interface BatchScrapeRequest {
  ...
  actions?: BatchScrapeRequestActions[];
...
export const batchScrapeRequestSchema: Schema<BatchScrapeRequest> = lazy(() =>
  typedExpandoObject(
    {
      ...
      actions: ['actions', optional(array(batchScrapeRequestActionsSchema))],
