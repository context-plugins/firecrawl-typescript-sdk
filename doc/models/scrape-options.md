...
| `actions` | [`ScrapeOptionsActions[] \| undefined`](../../doc/models/containers/scrape-options-actions.md) | Optional | This is Array of a container for one-of cases. |
...
```ts
import { Format, ScrapeOptions } from 'firecrawl-apilib';
