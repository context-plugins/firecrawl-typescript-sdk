...
| `webhook` | [`Webhook \| undefined`](../../doc/models/webhook.md) | Optional | A webhook specification object. |
| `ignoreInvalidUrLs` | `boolean \| undefined` | Optional | If invalid URLs are specified in the urls array, they will be ignored. Instead of them failing the entire request, a batch scrape using the remaining valid URLs will be created, and the invalid URLs will be returned in the invalidURLs field of the response.<br><br>**Default**: `false` |
...
| `actions` | [`BatchScrapeRequestActions[] \| undefined`](../../doc/models/containers/batch-scrape-request-actions.md) | Optional | This is Array of a container for one-of cases. |
...
```ts
import { BatchScrapeRequest, Event, Format } from 'firecrawl-apilib';
